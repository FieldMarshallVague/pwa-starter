...
export interface JsPlumbInstance {
    ...
    bind(
        event: 'connection',
        callback: (info: ConnectionMadeEventInfo, originalEvent: Event) => void, insertAtStart?: boolean/* =false */): void;
    ...
    getConnections(
        ...
        , flat?: boolean/* =false */): Array<any> | Map<any, any>;
    ...
    makeSource(
        ...
        , scope?: string, dragOptions?: Object
    ...
    makeTarget(
        ...
        , onMaxConnections?: Function): void;
